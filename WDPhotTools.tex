...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
This paper is organised as follows: in Section~\textsection2, we describe
...
\begin{enumerate}
    ...
    (see also Section~\textsection4.3 and Figure~\ref{fig:interstellar_reddening})
...
\begin{figure}
    \centering
    \includegraphics[width=\columnwidth]{fig_07_ifmrs.png}
